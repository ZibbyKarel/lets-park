 ...
 *
 * `monthLockState` / `isMonthOpen` in `@lets-park/shared-types` own the rule and
...
import { monthLockState, reservationWindowRange, startOfYearMonth } from '@lets-park/shared-types';
