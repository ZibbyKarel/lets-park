 ...
 *   `bulk-concurrency.db.spec.ts` forces, and which is the failure recorded in
 *   the task report. See `doc/decision/0092-*`.
 *
...
import type { BulkDayPlan } from '@lets-park/contract';
import type { DateOnly, ParkingGroup } from '@lets-park/shared-types';
import { PARKING_GROUPS, compareDateOnly, isBusinessDay } from '@lets-park/shared-types';
 ...
 * `libs/database`'s parity spec already pins that order against Postgres.
 */
