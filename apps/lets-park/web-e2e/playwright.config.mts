 ...
 *    `apps/lets-park/web/project.json` pins `next dev --port 4200` because of it. 4200 is
...
export default defineConfig({
  ...
  webServer: [
    ...
    },
    {
      ...
      // is now a real Nx dependency in `apps/lets-park/web-e2e/project.json` — it never
      ...
      cwd: join(workspaceRoot, 'apps', 'lets-park', 'web'),
      timeout: 180_000,
      stdout: 'pipe',
      stderr: 'pipe',
    },
