 ...
 * (`apps/lets-park/web/src/i18n/resolve-locale.ts` → `negotiateLocale` in `libs/shared/i18n`).
 ...
 * `apps/lets-park/web/messages/{cs,en}.json`, and the key is named so a rename is
