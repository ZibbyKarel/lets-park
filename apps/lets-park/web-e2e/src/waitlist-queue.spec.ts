 ...
 * instinct suggests.
 *
 * Everything here uses the shared `apps/lets-park/web-e2e/src/support` helpers for
 ...
 * literal Czech copy from `apps/lets-park/web/messages/cs.json`.
 */
 ...
 * `SpotDialog` (`apps/lets-park/web/src/lot/spot-dialog/spot-dialog.tsx`) is
