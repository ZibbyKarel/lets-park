 ...
 * (`apps/lets-park/web/src/shell/admin/admin-window-screen/admin-window-screen.tsx`).
 *
 ...
 * maximum (`MAX_OPEN_DAYS_BEFORE`, 31 — `libs/lets-park/database/src/scripts/reset-e2e.ts`)
 ...
 * it is enforced: `apps/lets-park/api/src/reservations/reservation-policy.spec.ts`,
