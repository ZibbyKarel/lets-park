 ...
 *
 * ## Why this is a TypeScript map and not a Zod schema in `libs/lets-park/contract`
 *
 ...
 * a JSONB column — and `libs/lets-park/contract` may not depend on `@lets-park/database`.
