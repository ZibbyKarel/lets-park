 ...
 * `ICS_FEED_BASE_PATH` in `libs/lets-park/contract`, and the data handed to the renderer
...
import { ICS_FEED_BASE_PATH, ICS_FEED_FILE_EXTENSION } from '@lets-park/contract';
...
export const CALENDAR_FILENAME = 'lets-park.ics';
