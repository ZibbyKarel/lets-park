 ...
 *
 * `@lets-park/contract/realtime` already declares every server → client payload
 ...
 * never both — see the schema comments in `libs/lets-park/contract/src/realtime/events.ts`.
...
import type { ServerToClientEvents } from '@lets-park/contract/realtime';
