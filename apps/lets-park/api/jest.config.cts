 ...
 *   `ERROR_DEFINITIONS`. Same three lines as `libs/lets-park/contract/jest.config.cts`;
 ...
 *
 * `libs/lets-park/contract/jest.config.cts` notes that a third project needing this
