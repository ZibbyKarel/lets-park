...
const nextConfig: NextConfig = {
  ...
  // `apps/lets-park/web/Dockerfile` copies; without it the image would have to carry the
  ...
  // Where tracing starts. This is an Nx monorepo: `apps/lets-park/web` has no
  // node_modules of its own, they are hoisted to the workspace root, and a
  // trace rooted at `apps/lets-park/web` would silently miss every one of them. Next.js
  ...
  // resulting `.next/standalone/apps/lets-park/web/server.js` layout the Dockerfile
