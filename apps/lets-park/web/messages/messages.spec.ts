 ...
 * augmented from it — `apps/lets-park/web/next-intl.d.ts`), so a key missing from `en.json`
 ...
 *   `apps/lets-park/web/tsconfig.spec.json` includes `messages/**\/*.spec.ts`.
 */
 ...
 * `apps/lets-park/web/tsconfig.spec.json` runs over this file.
 */
...
/**
 * Compile-time regression guard for `apps/lets-park/web/next-intl.d.ts`'s `AppConfig`
