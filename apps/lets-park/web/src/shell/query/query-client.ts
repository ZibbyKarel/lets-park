 ...
 * currently true:
 *
 * - **sign-out is a full navigation.** `apps/lets-park/web/src/shell/app-top-bar.tsx`
 ...
 *   `apps/lets-park/web/src/app/providers.tsx` uses `useState(() => createQueryClient())`,
 ...
 * over Socket.io (`libs/lets-park/realtime-client`) rather than by polling — so this is
