 ...
 *
 * Both seams are stubbed at the **wrapper**: `@lets-park/realtime-client` and
 * `@lets-park/auth/client`. Nothing here names `socket.io-client` or
 * `next-auth`, which `apps/lets-park/web` may not import at all; a real socket would need
