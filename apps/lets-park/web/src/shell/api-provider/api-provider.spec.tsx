 ...
 *
 * `createApiClient` is stubbed at the seam — the **wrapper**, `@lets-park/api-client`,
 * never `@orpc/client`, which `apps/lets-park/web` may not import at all. The session is
 * stubbed the same way, through `@lets-park/auth/client`: a real one would need
