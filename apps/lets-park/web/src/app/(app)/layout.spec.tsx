 ...
 * calls the real `useRequireAuth` from `libs/lets-park/auth`. The only thing doubled is
 ...
 * `@lets-park/auth/client` instead would have reduced this to asserting that a
 ...
 * Router runtime, and `@lets-park/api-client` because `ApiProvider` would
