...
// it must stay free of `@orpc/contract` (`libs/lets-park/contract/src/realtime/index.ts`).
 ...
 * (`apps/lets-park/api/src/realtime/lock.service.ts`). Re-declaring it structurally here
