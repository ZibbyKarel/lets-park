...
export interface SpotDialogProps {
   ...
   * queue (`libs/lets-park/contract/src/api/users.ts`'s `excludingReservedOrQueuedFor`).
   ...
   * themselves: `apps/lets-park/web-e2e/src/support/lot-page.ts:122-125` opens this dialog
