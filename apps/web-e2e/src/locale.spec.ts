 ...
 * (`apps/web/src/i18n/resolve-locale.ts` → `negotiateLocale` in `libs/i18n`).
 ...
 * `apps/web/messages/{cs,en}.json`, and the key is named so a rename is
 ...
 * `LOCALE_LABELS` in `libs/i18n` is intentionally endonymic (`Čeština`,
