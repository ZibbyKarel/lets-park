 ...
 * (`apps/web/src/shell/admin/admin-window-screen/admin-window-screen.tsx`).
 *
 ...
 * maximum (`MAX_OPEN_DAYS_BEFORE`, 31 — `libs/database/src/scripts/reset-e2e.ts`)
 ...
 * it is enforced: `apps/api/src/reservations/reservation-policy.spec.ts`,
