 ...
 * `admin` namespace of `apps/web/messages/cs.json`), there are no
 ...
 * behind an ARIA tab strip (`libs/design-system/src/primitives/lib/tabs`), so
...
/** The administration route. `apps/web/src/routes.ts`'s `ADMIN_ROUTE`. */
