 ...
 * `apps/web/src/shell/admin/admin-spots-screen/spot-form-dialog.tsx` uses —
 ...
 * `libs/design-system` (`plan.md`, design-system-first).
 */

import { Input, Select, Stack } from '@lets-park/design-system/primitives';
...
export function HolderFields({ options, holderId }: HolderFieldsProps) {
  ...
  return (
    <Stack spacing={4} className="mb-5">
