 ...
 *
 * `Locale` is deliberately *not* augmented: `Locale` is `libs/i18n`'s to define
 * (`libs/i18n/src/lib/locale.ts`), and declaring a second union here would give
 ...
 * this can live — `libs/i18n` may not read `apps/web/messages/cs.json`.
 */
