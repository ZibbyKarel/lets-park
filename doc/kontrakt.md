...
| časové razítko | `timestampSchema` (`z.iso.datetime()`) | ISO řetězec v UTC, ne `Date` (`doc/decision/0012-*`) |
...
`doc/decision/0010-*`. Pohyblivé svátky (Velký pátek, Velikonoční pondělí) se počítají
...
- `doc/decision/0010-kalendarni-aritmetika-a-jedina-hranice-casove-zony.md`
- `doc/decision/0011-dateonly-je-nebrandovany-string.md`
- `doc/decision/0012-casova-razitka-v-kontraktu-jsou-iso-retezce.md`
- `doc/decision/0013-uzavrene-vycty-a-uuid-v-kontraktu.md`
