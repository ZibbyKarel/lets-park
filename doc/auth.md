...
> regression. See `doc/decision/0038-*`.
...
The split is deliberate and is written up in `doc/decision/0037-*`. In short: an
...
Full reasoning and the risk of the email rebind: `doc/decision/0040-*`.
...
trade, and `doc/decision/0039-*` records it so nobody "fixes" it later without reading why.
...
over HTTP and not yet over WebSocket. `doc/decision/0038-*` explains it.
