# 0035 – `/health/live` na databázi nesahá, `/health/ready` ano – a s timeoutem
...
`doc/decision/0033-*`). Co sonda opravdu vrací, ověřuje `apps/api/src/app/http-pipeline.spec.ts`
