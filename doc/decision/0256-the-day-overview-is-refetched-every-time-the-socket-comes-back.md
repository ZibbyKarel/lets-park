...
`useLotRealtime` (`apps/web/src/lot/lot-screen/use-lot-realtime.ts`) watches
...
`libs/realtime-client` is unchanged.
...
`use-lot-realtime.ts`. `apps/web/src/lot/lot-screen/use-lot-realtime.spec.tsx` gains a
