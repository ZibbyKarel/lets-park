...
`apps/web/src/lot/use-lot-realtime.ts`:
...
`apps/web/src/lot/day-overview-cache.spec.ts` (24 tests, the pure patches and
the four predicates) and `apps/web/src/lot/use-lot-realtime.spec.tsx` (14
