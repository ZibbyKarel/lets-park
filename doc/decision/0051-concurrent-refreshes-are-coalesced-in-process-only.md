...
**Date:** 2026-09-02 · **Rewritten:** 2026-09-03 · **Status:** accepted · **Task:** 20 (`libs/auth`), review fix round 1; rewritten in the final-review fix round
...
paragraph the original record got wrong. `apps/web/src/auth.ts` calls
...
`libs/auth/src/lib/refresh.ts`: the returned function checks
