...
The global exception filter (`apps/api/src/common/filters/contract-exception.filter.ts`)
...
`libs/database/prisma/schema.prisma` therefore has to go through this function too; the
