...
**Date:** 2026-09-03 · **Status:** accepted · **Affects:** `apps/web/src/lot/bulk-*`
...
deliberately does **not** receive the plan the client is holding (`libs/contract/src/api/bulk.ts`,
