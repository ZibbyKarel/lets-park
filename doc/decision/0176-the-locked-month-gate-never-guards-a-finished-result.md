...
**Date:** 2026-09-03 · **Status:** accepted · **Affects:** `apps/web/src/lot/bulk-modal/bulk-modal.tsx`
...
- `apps/web/src/lot/bulk-modal/bulk-modal.tsx` — the `if (result !== null)` block moved above
