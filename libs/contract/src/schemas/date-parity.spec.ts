 ...
 *
 * `libs/shared-types` is `layer:foundation` with `allowedExternalImports: []`
 ...
 * `dateOnlySchema`; `libs/contract` would not want a second validation path.
 ...
 *
 * `libs/contract` is the only project that may import both: `type:contract`
