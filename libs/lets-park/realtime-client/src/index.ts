 ...
 * in is the one object the wrapper ban exists to keep out of `apps/lets-park/web` —
 ...
 * redeclared.
 *
 * `libs/lets-park/auth`'s `useAccessTokenProvider()` returns one of these and it feeds
