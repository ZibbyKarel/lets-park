 ...
 * `CLIENT_TO_SERVER_EVENT_SCHEMAS` (Task 15, `libs/lets-park/contract/src/realtime/commands.ts`).
...
import type { AcknowledgedEventName, ServerToClientEventName } from '@lets-park/contract/realtime';
 ...
 * straight to a logger in `apps/lets-park/web`.
 */
