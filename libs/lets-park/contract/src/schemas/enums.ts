 ...
 *
 * The allowed values live exactly once, in `@lets-park/shared-types`, because
 * `apps/lets-park/api` and `libs/shared/i18n` need them without pulling in Zod. The schemas here
