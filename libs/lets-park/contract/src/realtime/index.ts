/**
 * `@lets-park/contract/realtime` — the Socket.io half of the contract.
 *
 * A **separate entry point** from `@lets-park/contract`, and deliberately so:
 ...
 *                     the gateway and `libs/lets-park/realtime-client` dial
 */
export * from './events';
