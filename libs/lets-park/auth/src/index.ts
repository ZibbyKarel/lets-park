 ...
 * `@lets-park/auth/client` instead — see `libs/lets-park/auth/src/lib/client.tsx` for
 * why the two are kept apart.
 *
 * There is one way in, and it is `createAuth`: one call in `apps/lets-park/web` produces
