 ...
 * can actually run — the same split `libs/lets-park/contract` makes between its API and
...
export interface AuthProviderProps {
   ...
   * matches the server one instead of flashing "loading". `apps/lets-park/web` passes
