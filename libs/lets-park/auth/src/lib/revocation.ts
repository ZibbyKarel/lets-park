    ...
    super(
      ...
      runtime === ''
        ...
        : `Sign-out revocation cannot work on the "${runtime}" runtime: it keeps ` +
            ...
            'isolate. Serve apps/lets-park/web on the Node.js runtime (doc/decision/0100-*, ' +
            'doc/decision/0231-*).'
    );
 ...
 * any plain Node process that imports `libs/lets-park/auth` — where the variable does not
