 ...
 * (`eslint.config.mjs`, `WRAPPED_LIBRARIES`). `apps/lets-park/api`'s calendar controller
 ...
 * `apps/lets-park/api`'s calendar pipeline suite reads a rendered feed back and has to
