...
export interface CreatePrismaClientOptions {
   ...
   * read from `process.env` here: `apps/lets-park/api` validates its environment with Zod
   * at startup (`apps/lets-park/api/src/env.ts`) and this lib must not grow a second,
