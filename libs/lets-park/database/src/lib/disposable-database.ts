 ...
 * and `apps/lets-park/web-e2e`'s `globalSetup` spawns the script with the environment it
 ...
 * - Any single-label hostname (`postgres`, `lets-park-postgres`) — a Docker
 ...
 * `LETS_PARK_ALLOW_DESTRUCTIVE_RESET=1` in the environment. Somebody who wants
...
export const ALLOW_DESTRUCTIVE_RESET_ENV = 'LETS_PARK_ALLOW_DESTRUCTIVE_RESET';
