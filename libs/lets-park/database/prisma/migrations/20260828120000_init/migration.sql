...
--   prisma migrate diff --from-empty --to-schema libs/lets-park/database/prisma/schema.prisma --script
...
-- `libs/lets-park/shared-types/src/lib/domain-constants.ts`, which the contract's
