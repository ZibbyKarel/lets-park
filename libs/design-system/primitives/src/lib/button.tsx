...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  ...
  danger:
    'border-danger-100 bg-danger-100 text-danger font-bold hover:border-danger hover:bg-danger hover:text-fg-on-dark',
...
const DISABLED_CLASSES =
  'border-border bg-bg-muted text-border-strong shadow-none cursor-not-allowed';
